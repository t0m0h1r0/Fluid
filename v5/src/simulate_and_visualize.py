...
from numerics.poisson_solver.classic_poisson_solver import (
    ClassicPoissonSolver as PoissonSolver,
)
...
def initialize_fields(config: SimulationConfig, phase_solver: PhaseFieldSolver):
    ...
    for layer_config in config.layers:
        layer = Layer(phase_name=layer_config.phase, z_range=layer_config.z_range)
...
def main():
    ...
    writer.save_density_field(density, config, "density_t0.000")
